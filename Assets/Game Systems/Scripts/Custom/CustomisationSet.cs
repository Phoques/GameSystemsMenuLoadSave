...
public class CustomisationSet : MonoBehaviour
{
    ...
    //Texture 2D List for Skin mouth eyes hair clothes armour
    ...
    //current index value of skin mouth eyes hair clothes armour textures
    public int skinIndex, mouthIndex, eyesIndex, hairIndex, clothesIndex, armourIndex;

    //characer mesh renderer - this is so we can edit materials
    public SkinnedMeshRenderer character;
    //max amount of skin mouth eyes hair clothes armour textures (this is so we can load from resources)
    ...
    private void Start()
    {
        ...
        #region We do this after set texture
        SetTexture("Skin", 0);
        SetTexture("Eyes", 0);
        SetTexture("Mouth", 0);
        SetTexture("Hair", 0);
    ...
    public void SetTexture(string type, int dir)
    {
        ...
        // Arrays of 3 for example, if the index is 0, -1 then makes it 3. because it loops back around?
        index += dir;
        if (index < 0)
        {
            index = max - 1;
        ...
        #endregion
        #region Switch Set Index so inpector and code update with changes
        switch (type)
        {
            #region Skin
            case "Skin":
